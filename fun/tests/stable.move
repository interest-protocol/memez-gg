...
fun test_token_end_to_end() {
    ...
    let mut fr = memez_fixed_rate::new<Meme, SUI>(
        ...
        balance::create_for_testing(stable_config.meme_sale_amount()),
        fees.meme_swap(vector[STAKE_HOLDER]),
        fees.quote_swap(vector[STAKE_HOLDER]),
    );
    ...
    assert_eq(meme_token.value(), stable_config.meme_sale_amount());
    ...
    assert_eq(meme_coin.burn_for_testing(), stable_config.meme_sale_amount());
